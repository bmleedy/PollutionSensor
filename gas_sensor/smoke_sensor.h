...
class SmokeSensor {
 ...
 public:
  SmokeSensor(int dustPin, int ledPower, LiquidCrystal_I2C* lcd, uint8_t col, uint8_t row){
    this->col = col;
    this->row = row;
  ...
  void sense(){ //////////////////////////////////////////////////////////
    ...
    float dust_relative_volts = float(dust_val/1024.0*5.0) - DUST_ZERO;
...
//    if(dust_accum > 250.0){
//      snprintf(dust_accum, DESC_LEN, "Hazardous (Death)");
//    } else if(dust_accum > 150) {
//      snprintf(dust_desc, DESC_LEN, "V. Unhealthy (Purple)");
//    } else if(dust_accum > 55){
//      snprintf(dust_desc, DESC_LEN, "Unhealthy (Red)");
//    } else if(dust_accum > 35) {
//      snprintf(dust_desc, DESC_LEN, "USG (Orange)");
//    } else if(dust_accum > 12) {
